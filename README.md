...
Deployment ˚ ༘✶ ⋆｡˚ ⁀➷[_here_](https://rhanateix.github.io/progress_steps/)
...
- What problem does it (intend to) solve? Visual way to show the progress/steps necessary in an aplication
...
## Screenshots
![FInal Result](finalresultsteps.gif)
...
Room for improvement:
- Explore differents styles and shapes
